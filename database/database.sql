...
,('Alien on a Rampage','Clete Barrett Smith','Science Fiction',NULL,1,0,'TRUE')
...
,('Animorphs: The Beginning (Book 54)','K.A. Applegate','Science Fiction','T',1,0,'TRUE')
...
,('Confessions of a Murder Suspect','James Patterson & Maxine Paetro','Adventure',NULL,1,0,'TRUE')
,('Coraline','Neil Gaiman','Mystery','W',1,0,'TRUE')
,('Cover-Up: Mystery at the Super Bowl','John Feinstein','Mystery/Sports',NULL,1,0,'TRUE')
...
,('Daniel X: The Dangerous Days Daniel X (Book 1)','James Patterson & Michael Ledwidge','Science Ficiton',NULL,1,0,'TRUE')
,('Daniel X: Watch the Skies (Book 2)','James Patterson & Ned Rust','Science Ficiton',NULL,1,0,'TRUE')
...
,('Far Flung Adventures: Corby Flood (Book 2)','Paul Stewart & Chris Riddell','Adventure',NULL,1,0,'TRUE')
,('Far Flung Adventures: Fergus Crane (Book 1)','Paul Stewart & Chris Riddell','Adventure',NULL,1,0,'TRUE')
...
,('Genius of Common Sense: Jane Jacobs and the Story of the Death and Life of Great American Cities','Glenna Lang & Marjory Wunsch','Non-Fiction',NULL,1,0,'TRUE')
...
,('Hannah Montana: Rock the Waves','Suzanne Harper','Realistic Fiction',NULL,1,0,'TRUE')
...
,('How to Rock Braces and Glasses','Meg Haston','Realistic Fiction',NULL,2,0,'TRUE')
,('How to Write Haiku and Other Short Poems','Paul Janeczko','How To/Poetry',NULL,1,0,'TRUE')
...
,('I''m nobody! Who are you?: Poems by Emily Dickinson','Emily Dickinson','Poetry',NULL,1,0,'TRUE')
...
,('Kiss Me, Kill Me','Lauren Henderson','Mystery',NULL,1,0,'TRUE')
...
,('Lincoln: A Photobiography','Russell Freedman','Non-Fiction',NULL,1,0,'TRUE')
...
,('Magnus Chase and the Gods of Asgard: The Sword of Summer (Book 1)','Rick Riordan','Adventure',NULL,1,0,'TRUE')
...
,('Melindy''s Medal','Georgene Faulkner & John Becker','Adventure',NULL,1,0,'TRUE')
...
,('Peter Nimble and His Fantastic Eyes','Jonathan Auxier','Fantasy',NULL,1,0,'TRUE')
,('Peter Pan','J.M. Barrie','Classics','X',1,0,'TRUE')
,('Pinky and Rex','James Howe','Humor','L',1,0,'TRUE')
,('Pippa''s Perfect Ponytail','Julie Nickerson','Realistic Fiction',NULL,1,0,'TRUE')
,('Pocahontas','Joseph Bruchac','Historical Fiction','Y',1,0,'TRUE')
,('Poetry U.S.A.','Paul Molloy (editor)','Poetry',NULL,1,0,'TRUE')
...
,('Rat Life','Tedd Arnold','Mystery',NULL,1,0,'TRUE')
...
,('Spongebob Squarepants: Man Sponge Saves the Day','Sarah Willson','Humor',NULL,1,0,'TRUE')
,('Spongebob Squarepants: UFO!','Adam Beechen','Humor',NULL,1,0,'TRUE')
...
,('The Best Poems Ever: A Collection of Poetry''s Greatest Voices','Edric S. Mesmer (editor)','Poetry',NULL,1,0,'TRUE')
...
,('The Dead and the Gone','Susan Beth Pfeffer','Science Fiction',NULL,1,0,'TRUE')
...
,('The Dogs','Allan Stratton','Mystery',NULL,2,0,'TRUE')
,('The Dream Keeper and Other Poems','Langston Hughes','Poetry',NULL,1,0,'TRUE')
...
,('The Opposite of Hallelujah','Anna Jarzab','Realistic Fiction',NULL,1,0,'TRUE')
...
,('The Walking Dead: Rise of the Governor (Book 1)','Robert Kirkman & Jay Bonansinga','Dystopian/Thriller',NULL,2,0,'TRUE')
...
,('They All Fall Down','Roxanne St. Claire','Mystery/Thriller',NULL,2,0,'TRUE')
...
,('Whales, Dolphins, and Other Marine Mammals','George S. Fichter','Non-Fiction',NULL,1,0,'TRUE')
...
,('Writing Incredibily Short Plays Poems Stories','Norton Gretton','How To/Creative Writing',NULL,1,0,'TRUE')
